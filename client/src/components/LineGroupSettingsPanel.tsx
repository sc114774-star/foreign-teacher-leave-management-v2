...
export default function LineGroupSettingsPanel({ role, settings, onSave, onAction }: { role: "cingshan" | "dongyuan" | "admin"; settings: SupabaseLineGroupSetting[]; onSave: (school: School, groupId: string) => Promise<void>; onAction: (message: string, kind?: "success" | "error") => void }) {
